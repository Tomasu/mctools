...
class Renderer
{
	...
	private:
		...
		bool traceRayIntersection(const glm::vec3 &oldBlock, const glm::vec3& blockPos, const Ray& ray, BlockInfo& outInfo, float& distance);
		...
		bool fastVoxelLookCollision(const Ray &ray, BlockInfo &outInfo);
